...
public enum AuthErrorCode implements DomainErrorCode {
    ...
    ALREADY_REGISTERED_USER("AUTH_005", "이미 가입된 유저입니다.", HttpStatus.BAD_REQUEST),
    ALREADY_REGISTERED_WITH_OTHER_PROVIDER("AUTH_006", "다른 소셜로 가입된 계정입니다.", HttpStatus.BAD_REQUEST);
