...
@SuperBuilder
@Table(
        name = "post_place_report",
        uniqueConstraints = @UniqueConstraint(columnNames = { "archiver_id", "post_place_id" }))
public class PostPlaceReport extends BaseTimeEntity {
    ...
    public static PostPlaceReport createOf(UUID archiverId, Long postPlaceId) {
        return PostPlaceReport.builder()
